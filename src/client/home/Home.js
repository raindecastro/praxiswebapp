            ...
            >
              <div className={styles.messageContainer}>
                ...
                <p className={styles.letterParagraph}>
                  ...
                  versions, and after a good year and a half of trial and error,
                  I can confidently say that I'm actually seeing this project
                  through!
                </p>
                <p className={styles.letterParagraph}>
                  First up is Anastasia (of course), and this is probably the
                  most detailed of all the letters so far. Heavily influenced by
            ...
            >
              <div className={styles.messageContainer}>
                ...
                <p className={styles.letterParagraph}>
                  ...
                  this one on the movie, but the cast album accompanied me all
                  throughout (and has been on permanent loop since the Tonys).
                  On most days, I feel like telephone guy.
                </p>
              </div>
